...
This deploys a Cloud Deploy Delivery Pipeline with a single target with the Canary deployment strategy. `deployment_percentages` can be set to specify the traffic stages that would be applied during the canary deployment.
...
|---|---|:---:|:---:|:---:|
| [name](variables.tf#L173) | Name used for Cloud Deploy Pipeline. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L188) | Project id used for all resources. | <code>string</code> | ✓ |  |
| [region](variables.tf#L193) | Region used for all resources. | <code>string</code> | ✓ |  |
